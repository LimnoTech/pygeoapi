...
path_openai = r"C:\Users\sjordan\OneDrive - LimnoTech\Documents\GitHub\pygeoapi-limno\openai.yml"
content = generate_openapi_document(Path(path_config), "yaml")

with open(path_openai, "w") as output:
    output.write(content)

# now set the environment variable
os.environ["PYGEOAPI_OPENAPI"] = path_openai
